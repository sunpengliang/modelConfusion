...
class SELayer(nn.Module):
    ...
    def forward(self, x):
        b, c, _, _, _ = x.size()
        #print("batchsize %s and channel %s %s%s%s"%(b,c,x,y,z))
...
class RODEncode(nn.Module):
    ...
    def __init__(self):
        ...
        self.se1 = SELayer(160)
        self.se2 = SELayer(160)
        ...
        self.skip_se1 = SELayer(160)
        self.skip_se2 = SELayer(160)
        self.skip_se3 = SELayer(160)
